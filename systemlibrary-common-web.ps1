...
$skipDocumentationFor = @('MediaType', 'BaseOptions', 'LogLevel', 'PackageConfig.CacheConfiguration', 'PackageConfig.ClientConfiguration', 'PackageConfig.LogConfiguration', 'ClientResponse<T>', 'CacheConfiguration', 'ClientConfiguration', 'CalleeCancelledRequestException', 'RetryRequestException', 'GlobalEnumConverter', 'LogConfiguration', 'PackageConfig') # case sensitive
